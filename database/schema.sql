...
-- Importa este archivo manualmente en phpMyAdmin si prefieres instalar por SQL.
-- Los usuarios demo y el seed principal se crean desde /install para generar hashes de contraseña correctos.
