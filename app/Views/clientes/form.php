...
<div class="form-group"><label>Origen</label><input name="origen" value="<?= e(old('origen', $cliente['origen'] ?? '')) ?>"></div>
...
<div class="form-group span-2"><label><input type="checkbox" name="tiene_responsable" value="1" data-responsable-toggle <?= checked((old('tiene_responsable', (string)($cliente['tiene_responsable'] ?? '0')) === '1')) ?>> ¿Tiene contacto responsable?</label></div>
